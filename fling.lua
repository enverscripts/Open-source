...
flingBtn.BackgroundColor3 = Color3.fromRGB(70, 194, 70)
				...
				if root then
					for _, plr in pairs(Players:GetPlayers()) do
						if plr ~= LocalPlayer and plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") then
							...
							root.CFrame = targetHRP.CFrame * CFrame.new(math.random(-3,3),0,math.random(-3,3)) * CFrame.Angles(0, math.rad(50), 0)
